...
export default function Home() {
    ...
    return (
        <main className="w-full h-full pt-[120px] flex flex-col overflow-hidden">
            <div className="flex w-full flex-col px-6 md:items-start  pb-24 items-center xl:gap-[50px] justify-center xl:flex-row px-[300px]">
            ...
            <div className="flex flex-col w-full items-center justify-center py-[90px]">
               ...
               {containers.map((item) => (
                   <div className={`flex flex-col items-center justify-center py-[60px] bg-[${item.bg}] gap-[40px]`}>
